...
GM:AddWeaponPrerequisite(item,"axe")
local item = GM:AddPointShopWeapon(2,"bloodseeker", ITEMCAT_MELEE, 121, "weapon_zs_bloodseeker")
GM:AddWeaponPrerequisite(item,"butcher")
...
local item = GM:AddPointShopWeapon(4,"tear", ITEMCAT_MELEE, 429, "weapon_zs_tear")
